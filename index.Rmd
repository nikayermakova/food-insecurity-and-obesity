...
While we were interested in somewhat replicating the study conducted by the [Urban Institute](https://apps.urban.org/features/disrupting-food-insecurity/index.html), we also wanted to include obesity into our analysis. To examine the relationship between food insecurity and obesity, we needed relevant obesity data. We obtained this data from the [Behavioral Risk Factor Surveillance System](https://www.countyhealthrankings.org/health-data/health-factors/health-behaviors/diet-and-exercise/adult-obesity?year=2016&tab=0&state=53f). Since they had data spanning across a multitude of years, we decided to utilize data from 2016, as it aligned best with our food insecurity data.
...
The interaction term (B = 0.0052, p < .001) indicates that the interaction effect increases the impact of food insecurity on obesity as less than college education increases. It is a statistically significant and positive moderator. The R-squared value indicates that 41.98% of obesity is explained by this model.
...
The interaction term (B = -9.888e-06, p < .001) indicates that the interaction effect decreases the impact of food insecurity on obesity as median income increases. This interaction term is a statistically significant and negative moderator. The model explains 29.26% of the variance in obesity.
